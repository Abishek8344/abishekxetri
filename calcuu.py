...
fonttype=font.Font(family='Times New Roman')
...
button15=Button(root, text='',command=lambda :press('**'), height=4, width=7)
...
button17=Button(root,text='=',command=lambda :equalpress(),height=3, width=54)
